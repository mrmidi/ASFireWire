...
kern_return_t ASOHCIATRequestContext::Initialize(IOPCIDevice *pci,
                                                 uint8_t barIndex) {
  ...
  return ASOHCIContextBase::Initialize(pci, barIndex,
                                       ASContextKind::kAT_Request, offs);
}

void ASOHCIATRequestContext::ApplyPolicy(const ATRetryPolicy &retry,
...
kern_return_t ASOHCIATRequestContext::Enqueue(const ATDesc::Program &program,
