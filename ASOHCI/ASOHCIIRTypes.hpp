...
//   §10.3 (IR Context Registers), §10.5 (IR Interrupts), §10.6 (IR Data
//   Formats). Chapter 6 for global IntEvent / IsoRxIntEvent bit demux.
...
// IR interrupt policy for INPUT_LAST* descriptors 'i' field (OHCI §10.1.1,
// Table 10-1)
...
struct IRQueueOptions {
  ...
  IRIntPolicy interruptPolicy =
      IRIntPolicy::kNever;                      // §10.1.1 interrupt control
