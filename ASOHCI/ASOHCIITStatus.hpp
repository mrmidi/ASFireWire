...
// (Isochronous has no IEEE1394 ACK codes; we synthesize late/underrun/skip
// events.)
//
// Spec refs (OHCI 1.1): §9.5 (interrupt causes incl. underrun), §9.6 (timestamp
// fields), Chapter 6 (event capture)
