 ...
 * ASOHCIATContext
 *
 * Manages OHCI Asynchronous Transmit (AT) DMA context for FireWire packet
 * transmission. Handles descriptor block management and packet assembly for AT
 * Request and AT Response contexts.
 *
