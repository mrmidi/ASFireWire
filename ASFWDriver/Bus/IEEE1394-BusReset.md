...
**References:**
- IEEE 1394-2008: Complete specification (consolidates 1394-1995, 1394a-2000, 1394b-2002)
...
Figure 16-16 (Bus Reset State Machine):
...
2. **S4:A0b** - Normal completion:
   ...
   - **If node starts receiving new Self-ID packet**:
     ...
     - PHY transitions immediately out of A0: Idle into RX: Receive 
...
IEEE 1394-2008 Timing Parameters:
...
## Bus Reset State Machine (Detailed)
...
stateDiagram-v2
    ...
    state T0 {
        ...
        TreeIDStart: See Tree Identification section
    }
