...
//
// SyncAsyncBridge.hpp - family-neutral synchronous/asynchronous bridge
//
...
// paces the coordinator's separate endpoint/clock polling loops. The two are independent
