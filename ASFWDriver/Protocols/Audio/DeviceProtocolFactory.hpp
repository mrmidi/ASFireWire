...
public:
    ...
    static constexpr uint32_t kVeniceModelId = DeviceProfiles::Audio::kVeniceModelId;
    ...
    static constexpr const char* kVeniceModelName = DeviceProfiles::Audio::kVeniceModelName;
