...
actor MockASFWDriverControl: ASFWDriverControlling {
    ...
    func fetchAudioCursors() async -> [ASFWMCPAudioCursorSnapshot] {
        [ASFWMCPAudioCursorSnapshot(
            ...
            sampleRateHz: 48_000,
            outputChannels: 2,
            pcmOldestValidFrame: 10_000,
            pcmPublishedEndFrame: 14_096,
            scheduledFrameEnd: 13_984,
    ...
    func fetchTxLatencyReport(endpointID: AudioEndpointID, sessionId: UInt32 = 0) async -> TxLatencySessionReport? {
        let header = TxLatencySessionHeader(
            version: TxLatencyWireDecoder.wireVersion,
            sessionState: .frozen,
        ...
        let sample = TxLatencySample(
            ...
            validityFlags: 0x1F,
            encodeCompleteHostTicks: 1_011_000,
            offerStartHostTicks: 1_012_000,
            offerEndHostTicks: 1_013_000,
            transExaminedHostTicks: 1_014_000,
            descriptorUpdateHostTicks: 1_015_000,
            sealStartHostTicks: 0,
            sealEndHostTicks: 0,
            lastBeforeOfferHostTicks: 1_011_500,
            firstAfterOfferHostTicks: 1_014_000,
            lastBeforeOfferPassId: 9,
            firstAfterOfferPassId: 10,
            passId: 10,
            liveHwPos: 95,
            e0ToImageReadyNanos: 1_000,
            offerToExaminedNanosMin: 1_000,
            offerToExaminedNanosMax: 2_000,
            offerToFirstServiceNanosMin: 1_000,
            offerToFirstServiceNanosMax: 2_000,
            offerToDescriptorUpdateNanosMin: 2_000,
            offerToDescriptorUpdateNanosMax: 3_000,
            sealRelativeToOfferNanosMin: 0,
            sealRelativeToOfferNanosMax: 0,
            producerFlags: 0x7,
            transportFlags: 0x7,
            examinationCount: 2,
            hwDistancePackets: 5,
            ...
            observedArbPhase: 0,
            examinedArbPhase: 1,
            producerJoinResult: 0,
            transportJoinResult: 0,
            lastAttemptBindResult: 0
        )
